...
modelclass = list(MODEL_FOR_QUESTION_ANSWERING_MAPPING.keys())
modeltype = tuple(conf.model_type for conf in modelclass)
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Model type selected in the list: " + ", ".join(modeltype),
    )
    parser.add_argument(
        "--model_name_or_path",
        default=None,
